							...
							if attached l_feat_name_alias_as.aliases as l_aliases then
								...
								loop
									...
									then
										...
										create {VFAV1_SYNTAX} vfav.make_with_alias (l_feat_name_alias_as, ic.item.alias_name)
									end
								end
								if vfav /= Void then
										-- Error detected
