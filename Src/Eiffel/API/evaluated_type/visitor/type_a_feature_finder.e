...
feature -- Search
	...
	find_by_alias (n: like {FEATURE_I}.alias_name_ids.item; t: TYPE_A; c: CLASS_C)
		...
		do
			...
			context_class := c
			formal_generics := Void
			feature_in_class := agent (name: like {FEATURE_I}.alias_name_ids.item; lookup: CLASS_C): detachable FEATURE_I
				do
