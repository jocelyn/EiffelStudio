...
feature -- Element change
	...
	add_alias (a: STRING_8; c: like has_convert_mark)
		local
			lst: like aliases
		do
			lst := aliases
			...
			lst.force ([a, encoding_converter.utf8_to_utf32 (a), c])
		end
...
note
	...
	date: "$Date: 2018-11-12 13:14:22 +0100 (Mon, 12 Nov 2018) $"
	revision: "$Revision: 102420 $"
