...
feature -- Token codes
	...
	TE_CREATION: INTEGER = 322
	TE_PRECURSOR: INTEGER = 323
	TE_AGENT: INTEGER = 324
	TE_ALIAS: INTEGER = 325
	TE_ALL: INTEGER = 326
	TE_AS: INTEGER = 327
	TE_CHECK: INTEGER = 328
	TE_CLASS: INTEGER = 329
	TE_CONVERT: INTEGER = 330
	TE_CREATE: INTEGER = 331
	TE_DEBUG: INTEGER = 332
	TE_DO: INTEGER = 333
	TE_ELSE: INTEGER = 334
	TE_ELSEIF: INTEGER = 335
	TE_ENSURE: INTEGER = 336
	TE_EXPANDED: INTEGER = 337
	TE_EXPORT: INTEGER = 338
	TE_EXTERNAL: INTEGER = 339
	TE_FEATURE: INTEGER = 340
	TE_FROM: INTEGER = 341
	TE_IF: INTEGER = 342
	...
	TE_LOOP: INTEGER = 348
	TE_OBSOLETE: INTEGER = 349
	TE_ONCE: INTEGER = 350
	TE_ONCE_STRING: INTEGER = 351
	TE_REDEFINE: INTEGER = 352
	TE_REFERENCE: INTEGER = 353
	TE_RENAME: INTEGER = 354
	TE_REQUIRE: INTEGER = 355
	TE_RESCUE: INTEGER = 356
	TE_SELECT: INTEGER = 357
	TE_SEPARATE: INTEGER = 358
	TE_THEN: INTEGER = 359
	TE_UNDEFINE: INTEGER = 360
	TE_UNTIL: INTEGER = 361
	TE_VARIANT: INTEGER = 362
	TE_WHEN: INTEGER = 363
	TE_ACROSS: INTEGER = 364
	TE_ASSIGN: INTEGER = 365
	TE_ATTRIBUTE: INTEGER = 366
	TE_ATTACHED: INTEGER = 367
	TE_DETACHABLE: INTEGER = 368
	TE_INDEXING: INTEGER = 369
	TE_IS: INTEGER = 370
	TE_NOTE: INTEGER = 371
	TE_SOME: INTEGER = 372
	TE_STRING: INTEGER = 373
	TE_EMPTY_STRING: INTEGER = 374
	TE_VERBATIM_STRING: INTEGER = 375
	TE_EMPTY_VERBATIM_STRING: INTEGER = 376
	TE_STR_LT: INTEGER = 377
	TE_STR_LE: INTEGER = 378
	TE_STR_GT: INTEGER = 379
	TE_STR_GE: INTEGER = 380
	TE_STR_MINUS: INTEGER = 381
	TE_STR_PLUS: INTEGER = 382
	TE_STR_STAR: INTEGER = 383
	TE_STR_SLASH: INTEGER = 384
	TE_STR_MOD: INTEGER = 385
	TE_STR_DIV: INTEGER = 386
	TE_STR_POWER: INTEGER = 387
	TE_STR_AND: INTEGER = 388
	TE_STR_AND_THEN: INTEGER = 389
	TE_STR_IMPLIES: INTEGER = 390
	TE_STR_OR: INTEGER = 391
	TE_STR_OR_ELSE: INTEGER = 392
	TE_STR_XOR: INTEGER = 393
	TE_STR_NOT: INTEGER = 394
	TE_STR_FREE: INTEGER = 395
	TE_STR_BRACKET: INTEGER = 396
	TE_STR_PARENTHESES: INTEGER = 397
